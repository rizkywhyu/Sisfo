        ...
        <div class="agile-tables">
          <div class="w3l-table-info">
            ...
            <tbody>
              ...
              <?php 
                echo '  '; 
                echo anchor(site_url('transaksi/updateclient/'.$send->id),'<i class="fa fa-pencil-square-o"></i>',array('title'=>'edit','class'=>'btn btn-danger btn-sm')); 
                echo '  '; 
                echo anchor(site_url('transaksi/deleteclient/'.$send->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure to Delete ?\')"'); 
